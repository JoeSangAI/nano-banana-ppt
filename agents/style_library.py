...
STYLE_LIBRARY = {
    "claude_minimalist": {
        ...
        "accent_usage": "#D97757 (warm terracotta) works well for: key numbers, an emphasis word, thin underlines, or bullet markers. Fits the warm intellectual tone."
    },
    "neo_brutalism": {
        ...
        "accent_usage": "#E0FF4F (lime green) and #FF6666 (coral) punch hard against black/white — good for key numbers, emphasis words, filled tag boxes, or thick underlines."
    },
    "japanese_aesthetic": {
        ...
        "accent_usage": "#828C7E (sage green) suits this style when used with restraint — a single key word, a thin rule, or a subtle dot marker. Less is more."
    },
    "apple_keynote": {
        ...
        "palette": ["#000000", "#FFFFFF", "#0066CC", "#FF2D55", "#1D1D1F"],
        ...
        "accent_usage": "#0066CC (blue) works for product names, metrics, or CTA words. #FF2D55 (pink) suits emotional peak moments. Both glow well against black."
    },
    "liquid_glass": {
        ...
        "palette": ["#F2F2F7", "#1D1D1F", "#007AFF", "#34C759", "#8E8E93"],
        ...
        "accent_usage": "#007AFF (iOS blue) suits key numbers, active indicators, or CTA text. #34C759 (green) works for positive metrics. Can be applied as glowing text or glass card borders."
    },
    "magazine_editorial": {
        ...
        "accent_usage": "#8B0000 (deep crimson) creates maximum editorial impact when used sparingly — a key word, a thin rule, a pull-quote marker, or a page number."
    },
    "soft_3d_clay": {
        ...
        "accent_usage": "#FFB6C1 (soft pink) and #87CEFA (sky blue) feel playful and candy-like — good for emphasis words, pill-shaped tags, or icon fills."
    },
    "dark_luxury": {
        ...
        "accent_usage": "#D4AF37 (gold) shimmers well as metallic gradient text, glowing lines, or key numbers. Best reserved for emphasis — not body text."
    },
    "traditional_chinese": {
        ...
        "accent_usage": "#C83C23 (vermilion) and #4B5CC4 (indigo) carry cultural weight — suit a key character, a seal motif, a vertical rule, or a chapter number. Poetic restraint fits the aesthetic."
    },
    "holographic_chrome": {
        ...
        "accent_usage": "#4169E1 (royal blue), #FF00FF (magenta), #00FFFF (cyan) work as iridescent gradient accents — key numbers, headline words, chrome border glows. Best applied as holographic shimmer, not flat color."
    },
    "cyberpunk": {
        ...
        "accent_usage": "#66FCF1 (neon cyan) and #FF007F (neon magenta) glow well against dark backgrounds — suit key numbers, HUD-style labels, or glowing headline words."
    },
    "academic_paper": {
        ...
        "accent_usage": "#004B87 (academic blue) suits section numbers, figure labels, or key data points. #A32638 (academic red) works for critical findings or a key statistic."
    }
}
